...
## 4. Tech & Performance
38. [x] **Service Worker:** Basis-Implementierung für "Installierbarkeit" (PWA Kriterien erfüllen).
...
## 5. Content & Vertrauen
49. [x] **Glossar:** Erstellung einer `/glossar` Seite für SEO-Begriffe (Hologramme, Standzeit, etc.).
