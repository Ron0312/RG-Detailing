...
const WhatsAppButton = ({ message }) => (
    <a
        ...
        onClick={() => trackEvent('contact_click', { channel: 'whatsapp', location: 'calculator_result' })}
        className="flex items-center justify-center gap-3 bg-[#128C7E] hover:bg-[#0f7c6e] text-white px-6 py-4 rounded-xl font-bold transition-all duration-300 shadow-[0_0_20px_rgba(18,140,126,0.2)] hover:shadow-[0_0_40px_rgba(18,140,126,0.4)] hover:-translate-y-1 w-full mb-6 group border border-white/10 text-lg active:scale-95 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
    >
...
const BackButton = ({ onClick, className = '', children }) => (
    <button
        ...
        className={`group flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-bold uppercase tracking-widest transition-all
            bg-white/5 hover:bg-white/10 text-zinc-300 hover:text-white border border-white/5 hover:border-white/20 hover:shadow-lg active:scale-95 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900
            ${className}`}
    >
            ...
            <div className="relative bg-zinc-900/60 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden border border-white/10 p-3 pb-32 md:p-12 scroll-mt-32 ring-1 ring-black/5">
                ...
                <div className="min-h-[400px] transition-all duration-500 ease-in-out">
                            ...
                            <form onSubmit={submitQuote} className="max-w-lg mx-auto bg-white/5 p-6 md:p-8 rounded-3xl border border-white/10 backdrop-blur-sm" data-track-view="calculator-submit-form">
                                ...
                                <div className="flex gap-3 flex-col">
                                    ...
                                    <button
                                        ...
                                        disabled={loading}
                                        aria-busy={loading}
                                        className="w-full bg-zinc-100 hover:bg-white text-black px-6 py-4 rounded-xl font-bold transition-all duration-300 disabled:opacity-50 whitespace-nowrap border border-transparent hover:scale-[1.02] flex items-center justify-center gap-2 shadow-lg text-lg active:scale-95 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                                    >
                                        {loading ? (
                                            <>
                                                <Spinner />
                    ...
                    {step === STEPS.RESULT && submitted && (
                        <div className="animate-fade-in text-center py-20" role="status" aria-live="polite">
