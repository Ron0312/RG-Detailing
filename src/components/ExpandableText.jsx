    ...
    <div className="relative">
      ...
      {shouldShowButton && (
        <button
            ...
            className="mt-6 flex items-center gap-2 text-red-500 hover:text-red-400 font-bold text-sm tracking-widest uppercase group transition-colors rounded focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-black"
